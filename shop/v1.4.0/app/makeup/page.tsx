...
export default function Makeup() {
  const makeupProducts = ALL_PRODUCTS.filter(p => p.category === 'makeup')
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="bg-secondary/10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-2">کالکشن آرایش</h1>
          <p className="text-muted-foreground">محصولات آرایشی منتخب برای یک نتیجه تمیز و حرفه‌ای</p>
        </div>
      </section>
