      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-3xl p-8 shadow-xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-primary mb-2">REHHA</h1>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              />
              <span className="text-sm text-foreground">I agree to the <a href="#" className="text-primary hover:underline">Terms & Conditions</a></span>
            </label>
