...
export function FragranceContent() {
  const fragranceProducts = ALL_PRODUCTS.filter(p => p.category === 'fragrance')
    ...
    <>
      ...
      <section className="bg-secondary/10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-2">Fragrance Collection</h1>
          <p className="text-muted-foreground">Luxury scents for every occasion</p>
        </div>
      </section>
