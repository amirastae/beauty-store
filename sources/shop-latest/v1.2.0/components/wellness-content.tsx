    ...
    <>
      ...
      <section className="bg-secondary/10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-2">کالکشن سلامت و زیبایی</h1>
          <p className="text-muted-foreground">محصولات منتخب برای تکمیل روتین زیبایی و مراقبت شخصی</p>
        </div>
      </section>
