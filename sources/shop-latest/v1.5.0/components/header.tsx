      ...
      <div className="bg-primary text-primary-foreground text-xs sm:text-sm py-2 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-2 sm:gap-4 items-center">
            <span aria-label="زبان فارسی">FA</span>
      ...
      <header className="bg-card shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            {/* Logo */}
            <Link href="/" aria-label="VELOURA - خانه" className="flex items-center gap-2">
              <span className="w-9 h-9 rounded-full border border-primary/30 grid place-items-center text-primary font-serif text-lg">V</span>
              <span className="font-serif tracking-[.22em] text-lg sm:text-xl">VELOURA</span>
            </Link>
            ...
            <div className="md:hidden flex items-center gap-3">
              <Link href="/account" aria-label="حساب کاربری" className="text-foreground hover:text-primary transition">
                <User className="w-5 h-5" />
              </Link>
              <Link href="/wishlist" aria-label="علاقه‌مندی‌ها" className="text-foreground hover:text-primary transition"><Heart className="w-5 h-5" /></Link>
              <Link href="/cart" className="relative" aria-label="سبد خرید">
              ...
              <button type="button" aria-label={isOpen ? "بستن منو" : "باز کردن منو"} onClick={() => setIsOpen(!isOpen)}>
