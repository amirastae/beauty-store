...
export function WellnessContent() {
  const wellnessProducts = ALL_PRODUCTS.filter(p => p.category === 'wellness')
    ...
    <>
      ...
      <section className="bg-secondary/10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-2">Wellness Collection</h1>
          <p className="text-muted-foreground">Nourish your beauty from within with our wellness range</p>
        </div>
      </section>
