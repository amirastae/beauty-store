  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-foreground mb-8">فروشگاه وِلورا</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-64 flex-shrink-0">
            <div className="space-y-6 bg-card p-6 rounded-2xl shadow-md">
              ...
              {/* Price Filter */}
              <div>
                <h3 className="font-bold text-foreground mb-4">بازه قیمت</h3>
                <input
                  type="range"
                  min="0"
                  max="200"
              ...
              {/* Rating Filter */}
              <div>
                <h3 className="font-bold text-foreground mb-4">امتیاز</h3>
                <div className="space-y-2">
                  {[5, 4, 3].map(rate => (
              ...
              <div>
                ...
                <div className="space-y-2">
                  {['VELOURA', 'Selected Beauty', 'Premium Collection'].map(brand => (
