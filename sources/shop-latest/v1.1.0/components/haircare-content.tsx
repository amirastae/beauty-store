...
export function HaircareContent() {
  const haircareProducts = ALL_PRODUCTS.filter(p => p.category === 'haircare')
    ...
    <>
      ...
      <section className="bg-secondary/10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-2">Haircare Collection</h1>
          <p className="text-muted-foreground">Professional haircare products for healthy, beautiful hair</p>
        </div>
      </section>
