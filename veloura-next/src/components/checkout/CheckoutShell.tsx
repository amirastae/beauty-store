    ...
    <div className="checkout-layout">
      <section>
        ...
        <form className="checkout-form" onSubmit={submit} noValidate>
          ...
          <label>
            شماره موبایل
            <input name="mobile" required inputMode="tel" autoComplete="tel" placeholder="۰۹۱۲۱۲۳۴۵۶۷"/>
            {mobileError && <span className="checkout-field-error">{mobileError}</span>}
          </label>
          ...
          <label>
            کد پستی
            <input name="postalCode" required inputMode="numeric" autoComplete="postal-code" maxLength={10} placeholder="۱۰ رقم بدون خط تیره"/>
            {postalError && <span className="checkout-field-error">{postalError}</span>}
          </label>
        ...
        {done && <div className="checkout-success">
      ...
      <aside className="order-summary">
        ...
        <hr/><div><span>جمع کالاها</span><strong>{formatToman(total)}</strong></div>
