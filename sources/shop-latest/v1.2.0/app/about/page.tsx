...
export default function AboutPage() {
  ...
  const milestones = [
    { year: '2015', title: 'Founded', description: 'شروع مسیر وِلورا با تمرکز بر تجربه زیبایی مدرن' },
  ...
  <div className="max-w-5xl mx-auto relative text-center md:text-left">
    <div className="space-y-6">
      ...
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
        Luxury Beauty,
        <span className="text-primary"> زیبایی، با امضای تو</span>
      </h1>

      {/* Description */}
      <p className="text-lg md:text-xl text-white/80 leading-relaxed max-w-2xl">
        وِلورا با تمرکز بر انتخاب دقیق محصولات زیبایی، تجربه‌ای مدرن، لوکس و قابل‌اعتماد می‌سازد،
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  وِلورا با تمرکز بر زیبایی مدرن، انتخاب آگاهانه محصول و تجربه خرید دقیق شکل گرفته است.
                </p>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  هدف وِلورا ارائه تجربه‌ای حرفه‌ای، شفاف و ممتاز در خرید محصولات زیبایی است.
                </p>
              </div>
            </div>
          </div>
