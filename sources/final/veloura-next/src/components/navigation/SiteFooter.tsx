...
export default function SiteFooter(){
  return <footer className="site-footer">
    ...
    <div className="site-footer-links">
      ...
      <div><strong>FATIKHAN</strong><Link href="/about/">درباره ما</Link><Link href="/faq/">سوالات متداول</Link><Link href="/contact/">پشتیبانی</Link><Link href="/#shade-lab">Shade Lab</Link></div>
    </div>
